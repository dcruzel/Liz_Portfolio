    ...
    return (
        <section>
            ...
            <div className="carousel-inner">
                ...
                <img src="./assets/Project_pictures/Liz_Portfolio_img.png" className="d-block w-100" alt="..."/>
                <div className="carousel-caption d-none d-md-block">
                ...
                <div className="carousel-item">
                <img src="./assets/Project_pictures/Project_pic1-FreePikAI.jpg" className="d-block w-100" alt="..."/>
                <div className="carousel-caption d-none d-md-block">
