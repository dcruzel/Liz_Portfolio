    ...
    return (
        <section>
            ...
            <div className="carousel-inner">
                ...
                <img src="../Project_pictures/Training-App.png" className="d-block w-100" alt="Training App"/>
                ...
                <img src="../Project_pictures/Popcorn-Powers.png" className="d-block w-100" alt="Popcorn Powers"/>
                <div className="carousel-caption d-none d-md-block">
                ...
                <img src="../Project_pictures/Liz_Portfolio_img.png" className="d-block w-100" alt="..."/>
                <div className="carousel-caption d-none d-md-block">
                ...
                <div className="carousel-item">
                <img src="../Project_pictures/Project_pic2-FreePikAI.jpg" className="d-block w-100" alt="..."/>
                <div className="carousel-caption d-none d-md-block">
                ...
                <div className="carousel-item">
                <img src="../Project_pictures/Project_pic1-FreePikAI.jpg" className="d-block w-100" alt="..."/>
                <div className="carousel-caption d-none d-md-block">
